    ...
    <div id="wrapper">
        ...
        <div class="main">
            ...
            <div class="container-fluid">
                ...
                <div class="panel panel-headline">
                    <div class="panel-heading">
                        <h3 class="panel-title">Hasil Penilaian EPBM</h3>
                        <h4 class="panel-title"><b>Dikelompokkan Berdasarkan Pertanyaan</b></h4>
                    </div>
                    <div class="panel-body">
                        <div class="col">
                            <div class="col-md-3">
                                <div class="metric">
                                    ...
                                    <script>
                                        ...
                                        var dataset = [19, 36, 63, 96, 95];

                                        var pertanyaans = [
                                            { nilai: "N1", jumlah: dataset[0]},
                                            { nilai: "N2", jumlah: dataset[1]},
                                            { nilai: "N3", jumlah: dataset[2]},
                                            { nilai: "N4", jumlah: dataset[3]},
                                            { nilai: "N5", jumlah: dataset[4]},
                                        ];
                        ...
                        <br><br><br><br><br><br>
                        {{-- @foreach($rekap as $r)
                            <li>{{'Nama Guru: '. $r->nama_guru.' Nama Matpel: '.$r->nama_matpel.' ID Pertanyaan: '.$r->pertanyaan.' Nilai: '.$r->nilai.' Banyak: '.$r->count_nilai}}</li>
                        @endforeach --}}
                    </div>
                </div>
            </div>
